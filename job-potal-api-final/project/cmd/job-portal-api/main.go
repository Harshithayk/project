...
func startApp() error {
	...
	privatePEM, err := os.ReadFile(`C:\Users\HP\Desktop\final-testing\job-potal-api-final\project\private.pem`)
	if err != nil {
	...
	publicPEM, err := os.ReadFile(`C:\Users\HP\Desktop\final-testing\job-potal-api-final\project\pubkey.pem`)
	if err != nil {
